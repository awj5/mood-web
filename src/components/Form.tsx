  ...
  return (
    <>
      {!showForm ? (
        ...
        <p className="inline-block bg-gradient-to-r from-[#0000FF] via-[#990099] to-[#FF0000] bg-clip-text font-sans text-lg text-transparent dark:from-[#FF8000] dark:via-[#00FF00] dark:to-[#0080FF]">
